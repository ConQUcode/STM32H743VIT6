...
#define STEERING_CHASSIS_ALIGN_ECD_LF   5796 // ID3 左前
#define STEERING_CHASSIS_ALIGN_ECD_RF   7896 // ID4 右前
#define STEERING_CHASSIS_ALIGN_ECD_LB   6800 // ID1 左后
#define STEERING_CHASSIS_ALIGN_ECD_RB   8142 // ID2 右后
